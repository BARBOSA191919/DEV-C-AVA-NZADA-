...
void mostrar2(void) // descendente
{
   ...
   {
   	// en esta parte le cambiamos nuevo != NULL al while y le agregamos nuevo->ap2 != cab
   	  nuevo = new(lista);
   	  nuevo = cab2;
   	  while (nuevo->ap2 != cab)
   	  {
		 ...
		 nuevo = nuevo->ap2; 
		  ...
		  // acá le anexamos el cout de codigo y nombre para que los muestre de forma descendente
	  cout <<"\n"<<"Codigo  : "<<nuevo->codigo;
	  cout <<"\n"<<"Nombre  : "<<nuevo->nombre;
   }
   espera();   
